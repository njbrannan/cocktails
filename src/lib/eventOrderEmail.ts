...
export async function computeOrderListForEvent(supabaseServer: any, eventId: string) {
  const selectWithPacks =
    "servings, recipes(name, recipe_ingredients(ml_per_serving, ingredients(id, name, type, unit, bottle_size_ml, price, ingredient_packs(pack_size, pack_price, purchase_url, search_url, search_query, variant_sku, retailer, tier, is_active))))";
